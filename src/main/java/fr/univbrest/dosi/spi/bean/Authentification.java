...
@Entity
@NamedQueries({
	@NamedQuery(name = "Authentification.findByLoginAndPwd", query = "SELECT a FROM Authentification a WHERE a.loginConnection = :loginConnection AND a.motPasse = :motPasse"),
...
public class Authentification implements Serializable {
	...
	@SequenceGenerator(name="my_seq_gen2", sequenceName="AUT_SEQ")
	...
	public Authentification(long idConnection, String loginConnection,
			String role) {
		super();
