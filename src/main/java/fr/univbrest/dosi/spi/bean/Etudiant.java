...
@NamedQueries({
		...
		@NamedQuery(name = "Etudiant.findPromotionByNoEtudiant", query = "SELECT e.promotion FROM Etudiant e WHERE e.noEtudiant = :noEtudiant")
...
<<<<<<< HEAD
	...
	public Etudiant(String noEtudiant, String nom, String prenom, String sexe,
			Date dateNaissance, String lieuNaissance, String nationalite,
			String email, String adresse, String ville, String paysOrigine,
	...
	public boolean equals(Object object) {
		...
		if ((this.noEtudiant == null && other.noEtudiant != null)
				|| (this.noEtudiant != null && !this.noEtudiant
						.equals(other.noEtudiant))) {
			return false;
		}
		return true;
	}
