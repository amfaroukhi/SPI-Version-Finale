(function() {
  ...
  app.factory('enseignantsFactory', ['$http',function($http){
    var list = function() {
        ...
        return  $http.get('http://localhost:8090/enseignant/')
    ...
    return {
     ...
     // },
      ...
      get: function(noEnseignant) { 
    	  ...
    	  return  $http.get('http://localhost:8090/enseignant/getens/'+noEnseignant);
        ...
        if(idx){
          // TODO alimenter l'objet enseignant trouvé
        	...
        	var newEnseignant = {
  	        	...
  	        	$http.put('http://localhost:8090/enseignant/',newEnseignant);
          ...
          // TODO ajouter un enseignant à la liste
        	  ...
        	  var newEnseignant = {
	        	...
	        	$http.post('http://localhost:8090/enseignant/',newEnseignant);
      ...
      delete: function(noEnseignant) { 
        // TODO Supprimer 
    	  ...
    	  return  $http.delete('http://localhost:8090/enseignant/'+noEnseignant)
    	  //list.removeValue("no_enseignant",enseignant.no_enseignant);
    	  //return list;
      },
